...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo "<h2 style='color:red'>⚠️ TRANSFERIDO: R$ $valor para $destino</h2>";
    echo "<h3>Saldo restante: R$ {$_SESSION['saldo']}</h3>";
    echo "<p style='color:red'><strong>VOCÊ FOI HACKEADO!</strong> Esta página não tem proteção CSRF.</p>";
}
?>
...
<hr>
<p><strong>⚠️ VULNERÁVEL:</strong> Qualquer site pode enviar requisições para cá!</p>
